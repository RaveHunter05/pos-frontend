import { SignedOut, SignInButton, SignUpButton, useUser, SignedIn } from '@clerk/clerk-react';
		...
		<div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
			...
			<main className="container mx-auto px-6 py-20">
				<div className="max-w-4xl mx-auto text-center">
					...
					<p className="text-xl text-gray-600 mb-8 leading-relaxed">
						Gestiona tu inventario, productos, pedidos y facturas de manera eficiente.
					...
					<div className="grid md:grid-cols-3 gap-8 mt-20">
						<div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
							...
							<p className="text-gray-600">
								Controla tu stock, ajusta cantidades y monitorea tus productos en tiempo real.
							</p>
						</div>
						<div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
							<div className="text-4xl mb-4">🛒</div>
							<h3 className="text-xl font-semibold text-gray-900 mb-2">Punto de Venta</h3>
							<p className="text-gray-600">
						...
						<div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
							...
							<p className="text-gray-600">
								Obtén insights valiosos sobre tus ventas y rendimiento del negocio.
							</p>
						</div>
					</div>
				</div>
			...
			<footer className="bg-white/80 backdrop-blur-sm border-t border-gray-200 py-8 mt-20">
				<div className="container mx-auto px-6 text-center text-gray-600">
					<p>&copy; 2024 POS System. Todos los derechos reservados.</p>
				</div>
			</footer>
		</div>
	);
